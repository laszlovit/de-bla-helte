...
// function Header() {
//   return (
//     <div className="bg-primary/10 rounded-3xl mx-2 relative">
...
//         >
//           <path
//             d="M0,40 C300,80 900,80 1200,40 V120 H0 Z"
//             className="shape-fill"
//           ></path>
//         </svg>
//       </div>
//       <Container className="pt-16 sm:pt-24 md:pt-32">
//         <Heading as="h1">Creating clean spaces for a brighter future.</Heading>
...
//               At De Blå Helte, we are dedicated to transforming the way people
//               experience clean spaces. Our mission is to provide our customers
//               with a superior standard of cleanliness that gives them confidence
//               and peace of mind. We go above and beyond to ensure every space we
//               clean leaves a lasting impression.
//             </p>
...
//             </div>
//             <div className="mt-16">
//               <h2 className="text-lg/8 font-medium tracking-tight">
//                 Trusted by the world’s most innovative teams
//               </h2>
//               <div className="mx-auto mt-10 grid grid-cols-4 items-center gap-x-8 gap-y-10 sm:grid-cols-6 sm:gap-x-10 lg:mx-0 lg:grid-cols-3">
//                 <svg
...
//             </div>
//           </div>
//           <div className="relative pt-28 lg:row-span-2 lg:-mr-16 xl:mr-auto">

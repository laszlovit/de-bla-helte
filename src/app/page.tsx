    ...
    <div className="border-b border-slate-900/10 bg-white py-12 sm:py-16">
      <Container>
        ...
        <div className="mx-auto mt-10 grid max-w-lg grid-cols-4 items-center gap-x-8 gap-y-10 sm:max-w-xl sm:grid-cols-6 sm:gap-x-10 lg:mx-0 lg:max-w-none lg:grid-cols-5">
          ...
          <Image
            alt="SavvyCal"
            src="/home/dansk-bilglas-logo.png"
            width={158}
            height={48}
      ...
      <div className="mx-auto max-w-2xl md:text-center">
        ...
        <p className="mt-2 text-pretty font-[family-name:var(--font-outfit)] text-4xl font-semibold sm:text-5xl">
          ...
          <span className="relative whitespace-nowrap text-blue-600">
            ...
            <span className="relative">Cleaning Solutions</span>
          </span>
        </p>
        <p className="mt-6 text-lg tracking-tight text-slate-700">
          Focus on what matters most, while we handle the cleaning with ease and
        ...
        <div className="mx-auto max-w-2xl md:text-center">
          ...
          <p className="mt-2 text-pretty font-[family-name:var(--font-outfit)] text-4xl font-semibold sm:text-5xl">
            <span className="relative whitespace-nowrap text-blue-600">
              ...
              <span className="relative">Real Feedback</span>
            </span>{' '}
            <br />
